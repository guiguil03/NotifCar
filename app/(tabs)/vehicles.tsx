...
export default function VehiclesScreen() {
  ...
  // Charger au montage (déclarer après la définition pour éviter use-before-define)
  ...
  }, [vehicles, fadeAnim, slideAnim, cardAnimations]);
    ...
    try {
      ...
      if (editingVehicle) {
        ...
        const newVehicle = await VehicleService.createVehicle({
          ...vehicleData,
          name: vehicleData.name ?? `${vehicleData.brand} ${vehicleData.model}`,
          ownerId: user.id,
        });
      ...
      <ThemedView style={styles.container}>
        ...
        >
          <QRCodeGenerator
            ...
            qrCodeFromDB={selectedVehicle.qrCodeId}
              ...
              <View style={styles.heroSection}>
                ...
                >
                  ...
                  <ThemedText style={styles.heroSubtitle}>
                    Protégez votre véhicule avec notre système de signalisation
                    intelligent
                  </ThemedText>
                </LinearGradient>
              </View>
                ...
                <View style={styles.featuresGrid}>
                  <View style={styles.featureCard}>
                    ...
                    >
                      ...
                      <ThemedText style={styles.featureDescription}>
                        Chaque véhicule reçoit un QR code personnalisé pour une
                  ...
                  <View style={styles.featureCard}>
                    ...
                    >
                      ...
                      <ThemedText style={styles.featureDescription}>
                        Recevez des alertes immédiates en cas de problème avec
                        votre véhicule
                      </ThemedText>
                    </LinearGradient>
                  </View>
                  ...
                  <View style={styles.featureCard}>
                    ...
                    >
                      ...
                      <ThemedText style={styles.featureDescription}>
                        Échangez directement avec les personnes qui signalent un
                        problème
                      </ThemedText>
                    </LinearGradient>
                  </View>
