-- Script complet pour configurer le système de chat
-- Inclut toutes les fonctions RPC nécessaires

-- 1) Fonction pour créer/récupérer une conversation avec participants
...
-- 2) Fonction pour envoyer un message si l'utilisateur est participant
...
-- 3) Fonction pour récupérer les conversations d'un utilisateur
