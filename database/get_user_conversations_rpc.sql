-- Créer la fonction RPC pour récupérer les conversations d'un utilisateur
-- avec les détails du véhicule et de l'autre participant

-- 1) Supprimer l'ancienne version si elle existe
drop function if exists public.get_user_conversations(uuid);

-- 2) Créer la fonction get_user_conversations
